...
app.controller('VisitController', 
    ...
    $scope.setup = function (config) {
        ...
        $scope.Autocomplete = {
            ...
            view: 'visit/Visit',
            target : 'Vaccine',
            show : "Disease, Vaccine, Contraindications, known_side_effect",
            search : "Disease, Vaccine, Contraindications, known_side_effect",
            hide: 'id',
            ...
            query_field : "disease.name as Disease, vaccine.name as Vaccine, contraindication.condition as Contraindications, known_side_effect",
            ...
            set : "Disease, Vaccine, Contraindications, known_side_effect",
...
$scope.$parent.MenuSettings = {
  ...
  /********** Add Item to List of Requests **********/
    $scope.addItem = function () {
        ...
        $scope.$parent.items[index].status = 'scheduled';
    ...
    $scope.addBarcodedVaccine = function () {
        ...
        $scope.$parent.items.push(example);
